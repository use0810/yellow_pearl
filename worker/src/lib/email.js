...
const REORDER_URL = 'https://yellow-pearl.com/';
const RULE_LINE = '━━━━━━━━━━━━━━━━━━━━━━━━━━';
...
export function buildBankTransferExpiredBodies(order) {
  ...
  const text = [
    ...
    RULE_LINE,
    '',
    '本案内に伴い、お振込口座は無効となります。',
    'これ以降のお振込みは不要でございます。',
    '',
    '※本メールと行き違いでお振込みいただいた場合は、',
    '大変お手数ですが本メールへご返信いただけますようお願い申し上げます。',
    '',
    'なお、改めてご購入をご希望の場合は、',
    '下記ページより再度お申し込みいただけますと幸いです。',
    '（季節商品の性質上、在庫がなくなり次第受付終了となります。再お申し込みのタイミングによっては完売となる可能性もございますので、あらかじめご了承ください）',
    '',
    '▼ 再申し込みページ',
    REORDER_URL,
    '',
    'ご不明な点がございましたら、本メールまでお気軽にお問い合わせください。',
    '今後とも「郷のきみイエローパール」をよろしくお願い申し上げます。',
  ].join('\n');

  const html = `
    <p>${name}</p>
    <p>いつも「郷のきみイエローパール」をご愛顧いただき、<br>
    誠にありがとうございます。</p>
    ...
    <p>本案内に伴い、お振込口座は無効となります。<br>
    これ以降のお振込みは不要でございます。</p>
    <p>※本メールと行き違いでお振込みいただいた場合は、<br>
    大変お手数ですが本メールへご返信いただけますようお願い申し上げます。</p>
    <p>なお、改めてご購入をご希望の場合は、<br>
    下記ページより再度お申し込みいただけますと幸いです。<br>
    （季節商品の性質上、在庫がなくなり次第受付終了となります。再お申し込みのタイミングによっては完売となる可能性もございますので、あらかじめご了承ください）</p>
    <p>▼ 再申し込みページ<br>
    <a href="${REORDER_URL}">${REORDER_URL}</a></p>
    <p>ご不明な点がございましたら、本メールまでお気軽にお問い合わせください。<br>
    今後とも「郷のきみイエローパール」をよろしくお願い申し上げます。</p>
  `.trim();
...
export function bankTransferExpiredSubject(order) {
  return `【重要】「郷のきみイエローパール」ご予約キャンセルのご案内（注文番号：${order.order_id}）`;
}
